      ...
      <div className={featuresStyles.container}>
        <div className={featuresStyles.headerContainer}>
          <div className={featuresStyles.badge}>
            ...
            <span className={featuresStyles.badgeText}>Powerful Feature</span>
          ...
          <p className={featuresStyles.subtitle}>
            A minimal, intelligent interface that focus on what truly matters - create,send,and track invoices effortlessly while maintaining proffessional excellence.
          </p>
