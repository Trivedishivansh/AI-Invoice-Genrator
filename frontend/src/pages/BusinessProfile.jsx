...
const API_BASE = "https://ai-invoice-genrator-1.onrender.com";
//icons
...
const BusinessProfile = () => {
  ...
  //fetch user profile if it saved
   useEffect(() => {
    let mounted = true;
    ...
    <div className={businessProfileStyles.pageContainer}>
      <div className={businessProfileStyles.headerContainer}>
        ...
        <p className={businessProfileStyles.headerSubtitle}>
          Configure your company details,branding assets and invoice details
          ...
          <div className={businessProfileStyles.cardContainer}>
            ...
            <div className={businessProfileStyles.gridCols2}>
              ...
              <div>
                ...
                <input className={businessProfileStyles.input} value={meta.email || ""}
              ...
              <div className={businessProfileStyles.gridColSpan2}>
                ...
                <textarea rows={3}
                className={businessProfileStyles.textarea} value={meta.address || ""}
              ...
              <div>
                ...
                <input className={businessProfileStyles.input} value={meta.phone || ""}
              ...
              <div>
                ...
                <input className={businessProfileStyles.input} value={meta.gst || ""}
                onChange={(e)=>updateMeta("gst",e.target.value)}
                placeholder='21AAALP13CAZV' />
              </div>
              ...
              <div>
                ...
                <div className={businessProfileStyles.taxContainer}>
                  ...
                  <div className="flex items-center gap-3">
                    <input type='number' min='0' max='100' step="0.1" className={businessProfileStyles.textInput} value={meta.defaultTaxPercent ?? 18} onChange={(e) => updateMeta("defaultTaxPercent",Number(e.target.value || 0))} />
